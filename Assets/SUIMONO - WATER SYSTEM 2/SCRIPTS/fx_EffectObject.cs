...
namespace Suimono.Core
{
	...
	public class fx_EffectObject : MonoBehaviour {
		...
		public Sui_FX_ActionType actionType = Sui_FX_ActionType.none;
					...
					if (moduleObject.setTrack != null){
						...
						if (currentCamDistance <= effectDistance){
							...
							if (savePos != this.transform.position){
								currentSpeed = Vector3.Distance(savePos,new Vector3(this.transform.position.x,this.transform.position.y,this.transform.position.z))/Time.deltaTime;
							}
