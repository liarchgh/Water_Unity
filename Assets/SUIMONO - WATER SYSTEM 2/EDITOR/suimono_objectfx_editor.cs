...
public class suimono_objectfx_editor : Editor {
    ...
    Undo.RecordObject(target, "Changed Area Of Effect");
		...
		//script.systemIndex = EditorGUI.Popup(new Rect(rt.x+margin+110, rt.y+15, 260, 18),"",script.systemIndex, script.sysNames);
			...
			EditorGUI.LabelField(new Rect(rt.x+margin+10, rt.y+90, 130, 18),"Emission Speed");
			script.emitSpeed = EditorGUI.FloatField(new Rect(rt.x+margin+115, rt.y+90, 60, 18),"",script.emitSpeed);
				
			EditorGUI.LabelField(new Rect(rt.x+margin+210, rt.y+90, 130, 18),"Directional Speed");
			script.directionMultiplier = EditorGUI.FloatField(new Rect(rt.x+margin+320, rt.y+90, 40, 18),"",script.directionMultiplier);
			...
			EditorGUI.LabelField(new Rect(rt.x+margin+155, rt.y+115, 130, 18),"Tint Color");
			script.tintCol = EditorGUI.ColorField(new Rect(rt.x+margin+225, rt.y+114, 140, 18),"",script.tintCol);
			...
			EditorGUI.LabelField(new Rect(rt.x+margin+210, rt.y+135, 130, 18),"Distance Range");
			script.effectDistance = EditorGUI.FloatField(new Rect(rt.x+margin+320, rt.y+134, 40, 18),"",script.effectDistance);
